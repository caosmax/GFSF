...
tc_all<- read.csv("//dapadfs/workspace_cluster_6/Socioeconomia/GF_and_SF/BID_2/GraphGrownRate/tc_comparison_V2.csv")
tc_all$X<- NULL
...
Ymean<- read.csv(paste(grd1, "PromediosresumenPCA_V2.csv", sep = ""))
Ymean$X<- NULL
...
saveRDS(object = cfiles,file =paste(grd3,"AnalysisBID_V2.RDS", sep = ""))
