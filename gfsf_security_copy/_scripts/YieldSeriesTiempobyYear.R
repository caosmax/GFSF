...
#            width = 10, height = 7, units = 'in', res = 100)
      ...
      write.csv(db,file = paste("./RicePaper/", pots[[c]], "OutPutHWFAO.csv", sep = ""))
      ...
      write.csv(db_smooth,file = paste("./RicePaper/", pots[[c]], "OutPutSmoothFAO.csv", sep = ""))
...
lapply(1:length(pots), function(c){
      ...
      write.csv(local,file = paste("./RicePaper/", pots[[c]], "_shocksLocal&ForeighFAO.csv", sep = ""))
...
hv<- prop.table(t1)
write.csv(hv,file = paste("./RicePaper/","Years_hv_shocksLocal&ForeighFAO.csv", sep = ""))
...
sma_t<- prop.table(t1)
write.csv(sma_t,file = paste("./RicePaper/","Years_sma_shocksLocal&ForeighFAO.csv", sep = ""))
...
ema_t<- prop.table(t1)
write.csv(sma_t,file = paste("./RicePaper/","Years_ema_shocksLocal&ForeighFAO.csv", sep = ""))
...
hv<- prop.table(t1)
write.csv(hv,file = paste("./RicePaper/","Years_lac_hv_shocksLocal&ForeighFAO.csv", sep = ""))
...
sma_t<- prop.table(t1)
write.csv(sma_t,file = paste("./RicePaper/","Years_lac_sma_shocksLocal&ForeighFAO.csv", sep = ""))
...
ema_t<- prop.table(t1)
write.csv(sma_t,file = paste("./RicePaper/","Years_lac_ema_shocksLocal&ForeighFAO.csv", sep = ""))


###################################### 

write.csv(sdata,file = paste("./RicePaper/","Categories_shocksLocal&ForeighFAO.csv", sep = ""))
