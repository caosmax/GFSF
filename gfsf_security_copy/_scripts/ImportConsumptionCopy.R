...
### Ajustando categorias
fao_test$cat_f_hvW<- plyr::revalue(fao_test$cat_f_hvW,replace =c("Negative_Negative"="Negative","High_Positive"="Positive", "High_Negative"="Negative"))
fao_test$cat_localShock_smooth_sma<- plyr::revalue(fao_test$cat_localShock_smooth_sma,replace =c("Negative_Negative"="Negative","High_Positive"="Positive", "High_Negative"="Negative"))
fao_test$cat_localShock_smooth_ema<- plyr::revalue(fao_test$cat_localShock_smooth_ema,replace =c("Negative_Negative"="Negative","High_Positive"="Positive", "High_Negative"="Negative"))
fao_test$cat_localHV<- plyr::revalue(fao_test$cat_localHV,replace =c("Negative_Negative"="Negative","High_Positive"="Positive", "High_Negative"="Negative"))
fao_test$cat_f_smaW<- plyr::revalue(fao_test$cat_f_smaW,replace =c("Negative_Negative"="Negative","High_Positive"="Positive", "High_Negative"="Negative"))
fao_test$cat_f_emaW<- plyr::revalue(fao_test$cat_f_emaW,replace =c("Negative_Negative"="Negative","High_Positive"="Positive", "High_Negative"="Negative"))
...
pool.fao.world.hw<- plm(dffm_c ~ Dhw , data = all.fao,model ="pooling")
...
### exportar las tablas OLS a doc. 
tables.models.pool<- htmlreg(l = list(SumPool$HW, SumPool$EMA, SumPool$SMA),stars = c(0.001,0.01, 0.05, 0.1),
                             custom.model.names = c("HW", "EMA", "SMA"),file ="./RicePaper/FAOpool.doc",
                             inline.css = FALSE, doctype = TRUE, html.tag = TRUE, 
                             head.tag = TRUE, body.tag = TRUE)
...
###Fixed and ramdom 
all.fao<- pdata.frame(fimports, index = c("Area", "Year"))
fixed.fao.world.hw<- plm(dffm_c ~ Dhw , data = all.usda,model ="within")
fixed.fao.world.ema<- plm(dffm_c ~ Dema , data = all.usda,model ="within")
fixed.fao.world.sma<- plm(dffm_c ~ Dsma , data = all.usda,model ="within")
...
### exportar las tablas OLS a doc. 
tables.models.fixed.world<- htmlreg(l = list(SumPool$HW, SumPool$EMA, SumPool$SMA),stars = c(0.001,0.01, 0.05, 0.1),
                                    custom.model.names = c("HW", "EMA", "SMA"),file ="./RicePaper/FAOfixed.doc",
                                    inline.css = FALSE, doctype = TRUE, html.tag = TRUE, 
                                    head.tag = TRUE, body.tag = TRUE)
