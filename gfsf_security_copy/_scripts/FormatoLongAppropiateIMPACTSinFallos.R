...
write.csv(c_files,file='//dapadfs/workspace_cluster_6/Socioeconomia/GF_and_SF/BID_2/tc_copy/LongFormat_v3.csv',row.names=F)
...
write.csv(datacomplete,paste(pic,"tc_comparison_V3.csv", sep = ""))
