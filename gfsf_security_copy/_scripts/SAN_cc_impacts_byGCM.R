...
# write.csv(food,"./Results/fsvar.csv")
...
### Combinar gráficos ####
png(filename = paste("./pic/","cc_imp_model1.png", sep=""), width = 9, height = 6,
    units = 'in', res = 400)

gg <- ggarrange(gf1,gf3,gf5,gf7,gf9,gf11,gf13, ncol = 3, nrow = 3,common.legend = T,
                legend ="bottom")
plot(gg)
dev.off()
