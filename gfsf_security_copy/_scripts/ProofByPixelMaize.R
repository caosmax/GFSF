...
copyPix<-  c("//dapadfs/workspace_cluster_6/Socioeconomia/GF_and_SF/BID_2/Pixels/Maize/pix/")
grdpix<- c("//dapadfs/workspace_cluster_6/Socioeconomia/GF_and_SF/BID_2/Pixels/Maize/")
...
#             }
            ...
            cat(paste("Running MAIZE IRRI ", variedades[v], " of gcm ", gcm[g], " Done!!\n", sep = "" ))
...
#             }
            ...
            cat(paste("Running MAIZE RA ", variedades[v], " of gcm ", gcm[g], " Done!!\n", sep = "" ))
