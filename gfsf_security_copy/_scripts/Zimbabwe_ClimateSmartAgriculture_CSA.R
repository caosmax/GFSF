...
md<-read.csv("CSA_Zimbabwe.csv",header=T)
phi<- md
...
phi$commodity<-revalue(phi$commodity, c( "jpota"="Potato","cpota"="Potato",
                                         "cmaiz"="Maize",
                                         "jmaiz"="Maize","cbeef"="Beef","jbeef"="Beef","csorg"="Sorghum",
                                         "jsorg"="Sorghum","cwhea"="Wheat","jwhea"="Wheat","jvege"="Vegetable as group",
                                         "cvege"="Vegetable as group","cpota"="Potato","jpota"="Potato ","csugc"="Sugarcane",
                                         "jsugc"="Sugarcane","cgrnd"="OLS-Groundnut(Traded oilseeds)",
                                         "jgrnd"="OLS-Groundnut(Traded oilseeds)","cgdnt"="OLS-Groundnut(Non-traded oilseeds)",
                                         "jgdnt"="OLS-Groundnut(Non-traded oilseeds)","cgdol"="OIL-Groundnut(Processed oils)",
                                         "jgdol"="OIL-Groundnut(Processed oils)","cgdml"="MLS-Groundnut(Oilmeals)",
                                         "jgdml"="MLS-Groundnut(Oilmeals)","csoyb"="Soybean","jsoyb"="Soybean","csbnt"="OLS-Soybean(Non-traded oilseed)",
                                         "jsbnt"="OLS-Soybean(Non-traded oilseed)","csbol"="OIL-Soybean(Processed oils)",
                                         "jsbol"="OIL-Soybean(Processed oils)","csbml"="MLS-Soybean(Oilmeals)",
                                         "jsbml"="MLS-Soybean(Oilmeals)","ccott"="Cotton","jcott"="Cotton",
                                         "cols_groundnut"="OLS-Groundnut(group)","jols_groundnut"="OLS-Groundnut(group)",
                                         "cols_soybean"="OLS-Soybean(group)","jols_soybean"="OLS-Soybean(group)"))
...
cultivations<-  c( "Maize" ,"Sorghum" ,"Wheat" ,"Potato" , "Vegetable as group" ,"Sugarcane" ,  "OLS-Groundnut(Traded oilseeds)", 
                   "OLS-Groundnut(Non-traded oilseeds)","OIL-Groundnut(Processed oils)" ,"MLS-Groundnut(Oilmeals)",
                   "Soybean" ,"OLS-Soybean(Non-traded oilseed)","OIL-Soybean(Processed oils)","MLS-Soybean(Oilmeals)","Cotton",
                   "OLS-Groundnut(group)", "OLS-Soybean(group)")
cultivationsTrade<- c( "Beef","Maize" ,"Sorghum" ,"Wheat" ,"Potato" , "Vegetable as group" ,"Sugarcane" ,  "OLS-Groundnut(Traded oilseeds)", 
                       "OLS-Groundnut(Non-traded oilseeds)","OIL-Groundnut(Processed oils)" ,"MLS-Groundnut(Oilmeals)",
                       "Soybean" ,"OLS-Soybean(Non-traded oilseed)","OIL-Soybean(Processed oils)","MLS-Soybean(Oilmeals)","Cotton",
                       "OLS-Groundnut(group)", "OLS-Soybean(group)")
...
for (i in seq_along(datatotal)){
    ...
    png(filename=paste("C:/Users/CEGONZALEZ/Documents/CSA/",datatotal[i],"ZIM.png",sep=""), 
...
for (i in seq_along(dataagg)){
    ...
    png(filename=paste("C:/Users/CEGONZALEZ/Documents/CSA/",dataagg[i],"ZIM.png",sep=""), 
         width = 10, height = 10, units = 'in', res = 300)
...
for (i in seq_along(dataanimal)){
    ...
    png(filename=paste("C:/Users/CEGONZALEZ/Documents/CSA/",dataanimal[i],"ZIM.png",sep=""), 
         width = 10, height = 10, units = 'in', res = 300)
...
write.csv(mdwide_tan,paste(copy,"mdwideZIMTotal.csv", sep = ""), row.names = FALSE)
...
write.csv(tznet,paste(copy,"CambiosRelativosZIMTOTAL.csv", sep = ""), row.names = FALSE)
...
write.csv(c, paste(copy, "NettradeZIMTOTAL.csv", sep = ""),row.names = FALSE)
...
# write.csv(chicha, paste(copy, "NettradeMaizBHUTOTAL.csv", sep = ""),row.names = FALSE)
# 
...
write.csv(x =tznet2_t, file =paste(copy,"areayieldZIM.csv",sep = ""))
...
write.csv(csa, paste(copy, "ZIMCSAAreaYield.csv", sep = ""), row.names = FALSE)


#grafico Area de cultivo
png(filename=paste(grd,"AreaCommoditiesZIM.png", sep=""), width = 10, height = 10, units = 'in', res =800)
...
png(filename=paste(grd,"Numer Animales ZIM.png", sep=""), width = 10, height = 10, units = 'in', res =800)
