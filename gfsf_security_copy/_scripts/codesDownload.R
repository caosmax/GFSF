...
for(i in 1:length(at)){
      s <- get.Comtrade(r=at[[i]], p="all",ps="2016,2015,2014,2013,2012", cc="110814,071410", fmt="csv")
      s<- s$data
...
write.csv(append,"//dapadfs/workspace_cluster_6/Socioeconomia/GF_and_SF/BID_2/Comtrade/appendData1.csv")
