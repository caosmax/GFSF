...
for(i in seq_along(datatotal)){
      ...
      write.csv(bb,paste("./tables/",datatotal[i],"__SceWB85.csv",sep=""))
...
write.csv(brief,"./tables/summary_datatotal_SceWB85.csv")
...
for(i in seq_along(dataagg)){
      ...
      write.csv(bb,paste("./tables/",dataagg[i],"__SceWB85.csv",sep=""))
...
brief<- do.call(rbind,r)
write.csv(brief,"./tables/summary_dataagg__SceWB85.csv")
...
write.csv(bb, "./tables/NetTrade_GEN_SceWB85.csv")
...
ggsave(file= paste("test/AuFood_SceWB85.png",sep=""),aufood,width = 9,height = 7)
