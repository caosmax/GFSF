...
tc_all<- read.csv("//dapadfs/workspace_cluster_6/Socioeconomia/GF_and_SF/BID_2/GraphGrownRate/tc_comparison_v3.csv")
tc_all$X<- NULL
...
saveRDS(object = cfiles,file =paste(grd3,"AnalysisBID_v3.RDS", sep = ""))
