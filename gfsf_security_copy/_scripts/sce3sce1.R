...
for(i in seq_along(datatotal)){
      ...
      ggsave(file= paste("test/",datatotal[i],"_Sce3_Sce1.png",sep=""),e,width = 8,height = 8)
      
      write.csv(bb,paste("./tables/",datatotal[i],"_Sce3_Sce1.csv",sep=""))
...
write.csv(brief,"./tables/summary_datatotal__Sce3_Sce1.csv")
...
for(i in seq_along(dataagg)){
      ...
      ggsave(file= paste("test/",dataagg[i],"__Sce3_Sce1.png",sep=""),e,width = 8,height = 8)
      write.csv(bb,paste("./tables/",dataagg[i],"__Sce3_Sce1.csv",sep=""))
...
brief<- do.call(rbind,r)
write.csv(brief,"./tables/summary_datatotal_Sce3_Sce1.csv")
...
write.csv(bb, "./tables/NetTrade_GEN_Sce3_Sce1.csv")
...
ggsave(file= paste("test/Trade_Sce3_Sce1.png",sep=""),trade,width = 9,height = 7)
write.csv(bb, "./tables/NetTrade_Sce3_Sce1.csv")
