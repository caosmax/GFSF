...
write.csv(no,paste("./tables/NOCC_SSP4.csv", sep = ""))
...
for(i in seq_along(datatotal)){
      ...
      # base<- base %>% spread(year,Val)
      # write.csv(df,paste("./tables/",ref,"_SSP4.csv", sep = ""))
      ...
      write.csv(bb,paste("./tables/perc_changeByYear_", datatotal[i],"_SSP4.csv"))
...
for(i in seq_along(dataagg)){
      ...
      write.csv(bb,paste("./tables/perc_changeByYear_", dataagg[i],"_SSP4.csv"))
...
write.csv(bb,paste("./tables/perc_changeByYear_", dataespecial,"_SSP4.csv"))
...
for(i in seq_along(datasys)){
      ...
      write.csv(bb,paste("./tables/perc_changeByYear_", datasys[i],"_SSP4.csv"))
