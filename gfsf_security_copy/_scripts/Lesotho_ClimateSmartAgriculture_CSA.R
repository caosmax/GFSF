...
md<-read.csv("CSA_Lesotho.csv",header=T)
phi<- md
...
phi$commodity<-revalue(phi$commodity, c( "jpota"="Potato",
                                         ...
                                         "jpoul"="Poultry",
                                         "cpoul"="Poultry",
                                         "jlamb"="Sheeps and goats",
                                         "clamb"="Sheeps and goats",
                                         "cbean"="Beans",
                                         "jbean"="Beans"))
...
for (i in seq_along(datatotal)){
    ...
    png(filename=paste("C:/Users/CEGONZALEZ/Documents/CSA/",datatotal[i],"LES.png",sep=""), 
...
for (i in seq_along(dataagg)){
    ...
    png(filename=paste("C:/Users/CEGONZALEZ/Documents/CSA/",dataagg[i],"LES.png",sep=""), 
         width = 10, height = 10, units = 'in', res = 300)
...
for (i in seq_along(dataanimal)){
    ...
    png(filename=paste("C:/Users/CEGONZALEZ/Documents/CSA/",dataanimal[i],"LES.png",sep=""), 
         width = 10, height = 10, units = 'in', res = 300)
...
for (i in seq_along(dataespecial)){
    ...
    png(filename=paste("C:/Users/CEGONZALEZ/Documents/CSA/",dataespecial[i],"LES.png",sep=""), 
         width = 10, height = 10, units = 'in', res = 300)
...
write.csv(tznet,paste(copy,"CambiosRelativosLESTOTAL.csv", sep = ""), row.names = FALSE)
...
write.csv(c, paste(copy, "NettradeLESMTOTAL.csv", sep = ""),row.names = FALSE)
...
write.csv(x =tznet2_t, file =paste(copy,"areayieldBEL.csv",sep = ""))
