...
proof<- proof[,-c(4:8)]
colnames(proof)<- c("Commodity", "Regions","parameter", "HIGH+NARS","HIGH","RMM", "REGION")
...
write.csv(efiles,paste(rdsFiles,"YieldDiffReference_HeapMapPP.csv",sep=""))
## grafico yield
...
efiles$parameter <- factor(efiles$parameter, levels = c("Yield","Area","Supply"))
