...
setwd("//dapadfs/workspace_cluster_6/Socioeconomia/GF_and_SF/BID_2/SoybeanIRRI/Soybean_Future")
...
png(filename=paste(copy,"IRRI_SoybeanVarietiesGCMs.png",sep=""), 
...
setwd("//dapadfs/workspace_cluster_6/Socioeconomia/GF_and_SF/BID_2/SoybeanRA/Soybean_Future")
copy<- c("//dapadfs/workspace_cluster_6/Socioeconomia/GF_and_SF/BID_2/graphs/")
...
png(filename=paste(copy,"RA_SoybeanVarietiesWFD.png",sep=""), 
     width = 18, height = 12, units = 'in', res = 100)
...
setwd("C:/Users/CEGONZALEZ/Documents/BIDCarlos/BIDsecundVersion/SoybeanRA/Soybean_Future")
copy<- c("//dapadfs/workspace_cluster_6/Socioeconomia/GF_and_SF/BID_2/graphs/")
...
png(filename=paste(copy,"RA_SoybeanVarietiesGCMs.png",sep=""), 
     width = 18, height = 12, units = 'in', res = 100)
...
setwd("C:/Users/CEGONZALEZ/Documents/BIDCarlos/BIDsecundVersion/SoybeanRA/Soybean_Historical")
copy<- c("//dapadfs/workspace_cluster_6/Socioeconomia/GF_and_SF/BID_2/graphs/")
