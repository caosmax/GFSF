...
md<-read.csv("CSA_Belize2.csv",header=T)
phi<- md
...
phi$commodity<-revalue(phi$commodity, c( "cmaiz"="Corn",
                                         "jmaiz"="Corn",
                                         "cbeef"="Beef",
                                         "jbeef"="Beef",
...
cultivations<-  c( "Corn", "Rice", "Beans","Banana", "Tropical Fruit" ,"Vegetable as group", "Sugarcane", "Cocoa")
cultivationsTrade<- c("Beef","Corn","Rice", "Beans", "Banana","Tropical Fruit" ,"Vegetable as group" ,"Sugarcane","Cocoa")
...
require(xlsx)
write.xlsx( x = z,file= paste(copy, "BEL2.xlsx", sep = ""),
...
for (i in seq_along(datatotal)){
    ...
    png(filename=paste("C:/Users/CEGONZALEZ/Documents/CSA/",datatotal[i],"BEL2.png",sep=""), 
...
for (i in seq_along(dataagg)){
    ...
    png(filename=paste("C:/Users/CEGONZALEZ/Documents/CSA/",dataagg[i],"BEL2.png",sep=""), 
         width = 10, height = 10, units = 'in', res = 300)
...
for (i in seq_along(dataanimal)){
    ...
    png(filename=paste("C:/Users/CEGONZALEZ/Documents/CSA/",dataanimal[i],"BEL2.png",sep=""), 
         width = 10, height = 10, units = 'in', res = 300)
...
for (i in seq_along(dataespecial)){
    ...
    png(filename=paste("C:/Users/CEGONZALEZ/Documents/CSA/",dataespecial[i],"BEL2.png",sep=""), 
         width = 10, height = 10, units = 'in', res = 300)
...
for (i in seq_along(datasys)){
    ...
    png(filename=paste("C:/Users/CEGONZALEZ/Documents/CSA/",datasys[i],"BEL2.png",sep=""), 
         width = 10, height = 10, units = 'in', res = 300)
...
write.csv(mdwide_tan,paste(copy,"mdwideBELTotal2.csv", sep = ""), row.names = FALSE)
...
write.csv(tznet,paste(copy,"CambiosRelativosBELTOTAL2.csv", sep = ""), row.names = FALSE)
...
write.csv(c, paste(copy, "NettradeBELMTOTAL2.csv", sep = ""),row.names = FALSE)
...
write.csv(x =tznet2_t, file =paste(copy,"areayieldBEL2.csv",sep = ""))
...
write.csv(csa, paste(copy, "BELCSAAreaYield2.csv", sep = ""), row.names = FALSE)


#grafico Area de cultivo
png(filename=paste(grd,"AreaCommoditiesBEL2.png", sep=""), width = 10, height = 10, units = 'in', res =800)
...
png(filename=paste(grd,"Numer Animales BEL2.png", sep=""), width = 10, height = 10, units = 'in', res =800)
