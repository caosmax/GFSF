...
setwd("C:/Users/CEGONZALEZ/Documents/BIDCarlos/BIDsecundVersion/Maize_IRR/Maize_Future")
...
tiff(filename=paste(copy,"IRRI_Maize_VarietiesGCMs.tiff",sep=""), 
...
setwd("C:/Users/CEGONZALEZ/Documents/BIDCarlos/BIDsecundVersion/Maize_IRR/Maize_Historical")
copy<- c("//dapadfs/workspace_cluster_6/Socioeconomia/GF_and_SF/BID_2/")
...
tiff(filename=paste(copy,"IRR_MaizeVarietiesWFD.tiff",sep=""), 
     width = 18, height = 12, units = 'in', res = 100)
...
setwd("C:/Users/CEGONZALEZ/Documents/BIDCarlos/BIDsecundVersion/Maize_RA/Maize_Future")
copy<- c("//dapadfs/workspace_cluster_6/Socioeconomia/GF_and_SF/BID_2/")
...
tiff(filename=paste(copy,"RA_MaizeVarietiesGCMs.tiff",sep=""), 
     width = 18, height = 12, units = 'in', res = 100)
...
setwd("C:/Users/CEGONZALEZ/Documents/BIDCarlos/BIDsecundVersion/Maize_RA/Maize_Historical")
copy<- c("//dapadfs/workspace_cluster_6/Socioeconomia/GF_and_SF/BID_2/")
...
tiff(filename=paste(copy,"RA_MaizeVarietiesWFD.tiff",sep=""), 
     width = 18, height = 12, units = 'in', res = 100)
