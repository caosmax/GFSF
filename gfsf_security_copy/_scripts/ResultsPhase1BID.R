...
grp<- c("//dapadfs/workspace_cluster_6/Socioeconomia/GF_and_SF/BID_2/ResultsIMPACT/AggregationBID/Phase1/Test/")

#Cargar marco de datos principal
md<-read.csv("Phase1/Resultados_Ciat_StCty_31_08_16_new.csv",header=T)

Parameters<- c("QSXAgg -- Total Production","TAreaXAgg -- Total Area", "QNXAgg -- Net Trade","QDXAgg -- Total Demand")
crops<- c("jbean", "jrice", "jwhea" , "cmaiz", "csoyb", "jmaize", "jsoyb", "cbean", "crice", "cwhea")
...
jcrops<-c ("jbean","jmaize","jwhea","jsoyb","jrice")
...
cropsj<-c("jbean","jmaize","jrice","jsoyb","jwhea")
