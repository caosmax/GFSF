...
lapply(1:length(pots), function(c){
      ...
      #################################################Country###############################################################
      workdi<- "//dapadfs/workspace_cluster_6/Socioeconomia/GF_and_SF/BID_2/Comtrade/RicePaper/usda/temporal/"
      cfiles<- filter(usda_rice, Area==pots[[c]]) #%>% filter(., Element=="Yield")
      
      test_i<- ts(cfiles[3], start =c(1961))
      ...
      # cargar datos 
      load(paste("./RicePaper/usda/temporal/", pots[[c]], ".RData", sep = ""))
      ...
      write.csv(db,file = paste("./RicePaper/usda/temporal/", pots[[c]], "OutPutHW.csv", sep = ""))
      ...
      write.csv(db_smooth,file = paste("./RicePaper/usda/temporal/", pots[[c]], "OutPutSmooth.csv", sep = ""))
      ...
      write.csv(brief,file = paste("./RicePaper/usda/temporal/", pots[[c]], "briefDesy.csv", sep = ""))
...
### load data 
shockW<- list.files(path="./RicePaper/usda/temporal/", pattern = "briefDesy", all.files = T,full.names = T)
...
lapply(1:length(pots), function(c){
      ...
      write.csv(local,file = paste("./RicePaper/usda/temporal/", pots[[c]], "_shocksLocal&Foreigh.csv", sep = ""))
...
### load data 
shockComplete<- list.files(path="./RicePaper/usda/temporal/", pattern = "shocksLocal&Foreigh", all.files = T,full.names = T)
...
write.csv(gdata,file = paste("./RicePaper/usda/temporal/", "NumericCategoriesUSDA.csv", sep = ""))
...
for ( v in 1:length(var)){
      ...
      ## logica de los valores 
      nn<-  which(gdata[,var[v]]<(-1))
      #       mr<-  which(gdata[,var[v]]<0 & gdata[,var[v]]>-1)
      hp<-  which(gdata[,var[v]]>1)    
      mr<-  which(gdata[,var[v]]>-1 & gdata[,var[v]]<=1)
...
hv<- prop.table(t1)
write.csv(hv,file = paste("./RicePaper/usda/temporal/","Years_hv_shocksLocal&ForeighUSDA.csv", sep = ""))
...
sma_t<- prop.table(t1)
write.csv(sma_t,file = paste("./RicePaper/usda/temporal","Years_sma_shocksLocal&ForeighUSDA.csv", sep = ""))
...
ema_t<- prop.table(t1)
write.csv(sma_t,file = paste("./RicePaper/usda/temporal/","Years_ema_shocksLocal&ForeighUSDA.csv", sep = ""))
...
hv<- prop.table(t1)
write.csv(hv,file = paste("./RicePaper/usda/temporal/","Years_lac_hv_shocksLocal&ForeighUSDA.csv", sep = ""))
...
sma_t<- prop.table(t1)
write.csv(sma_t,file = paste("./RicePaper/usda/temporal/","Years_lac_sma_shocksLocal&ForeighUSDA.csv", sep = ""))
...
ema_t<- prop.table(t1)
write.csv(sma_t,file = paste("./RicePaper/usda/temporal/","Years_lac_ema_shocksLocal&ForeighUSDA.csv", sep = ""))


###################################### 

write.csv(sdata,file = paste("./RicePaper/usda/temporal/","Categories_shocksLocal&ForeighUSDA.csv", sep = ""))
