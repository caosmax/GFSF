...
copyPix<-  c("//dapadfs/workspace_cluster_6/Socioeconomia/GF_and_SF/BID_2/Pixels/Bean/pix/")
grdpix<- c("//dapadfs/workspace_cluster_6/Socioeconomia/GF_and_SF/BID_2/Pixels/Bean/")
...
#             }
            ...
            cat(paste("Running BEAN IRRI ", variedades[v], " of gcm ", gcm[g], " Done!!\n", sep = "" ))
...
#             }
            ...
            cat(paste("Running BEAN RA ", variedades[v], " of gcm ", gcm[g], " Done!!\n", sep = "" ))
